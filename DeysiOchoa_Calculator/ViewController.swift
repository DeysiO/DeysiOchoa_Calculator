...
// 0 is the defaulth number
    var firstNumber = 0
    
    var resultNumber = 0
    
    var currentOperations: Operation?
// these are the functions we are going to add
    enum Operation {
        
        case add, subtract, multiply, divide
    }
// these are the colors and size of the button
...
// will create the width and height for button
...
// these are the operations we are going to use
        let operations = ["=","+", "-", "x", "/"]
        ...
        if tag == 1 {
            ...
            if let operation = currentOperations {
                ...
                case .divide:
                    ...
                    /// create 2=5 tags to demonstate .add, subtract, multiply and divide
                }
            }
        }
        else if tag == 2 {
